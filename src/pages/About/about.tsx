  ...
  return (
    <>
      <DefaultLayout>
        ...
        <motion.section
          className="flex flex-col items-center justify-center gap-4 py-8 md:py-10 px-4 md:px-0"
          initial="hidden"
          animate="visible"
          variants={containerVariants}
        >
          <motion.div className="text-center max-w-3xl" variants={itemVariants}>
            <h1 className={title({ color: "violet", size: "sm" })}>Crafting Aquatic Masterpieces</h1>
            <h2 className={subtitle({ class: "mt-4 text-sm md:text-base" })}>
